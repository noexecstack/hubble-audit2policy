...
- GitHub Actions workflow for automated PyPI publishing on release. Uses OIDC trusted publishing for keyless authentication.
- Package is now available on PyPI: `pip install hubble-audit2policy`
